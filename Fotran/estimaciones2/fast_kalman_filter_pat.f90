...
SUBROUTINE FAST_KAL_FILT_PAT(Z,H,T,R,Q,Y,A_INI,P_INI,NUM_OBS,NUM_EST,NUM_K,NUM_DIST_EST,NUM_PER,LOG_L)
  IMPLICIT NONE
  INTEGER, INTENT(IN) :: NUM_OBS, NUM_EST, NUM_DIST_EST, NUM_PER, NUM_K
