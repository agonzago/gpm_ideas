...
M_.block_structure.block(1).equation = [ 5 6 7];
...
M_.block_structure.block(2).equation = [ 3 1 2 4 8 9];
M_.block_structure.block(2).variable = [ 3 1 2 4 8 9];
M_.block_structure.block(2).is_linear = true;
M_.block_structure.block(2).NNZDerivatives = 20;
M_.block_structure.block(2).bytecode_jacob_cols_to_sparse = [1 2 3 7 8 9 10 11 12 14 15 16 17 18 ];
M_.block_structure.block(1).g1_sparse_rowval = int32([]);
M_.block_structure.block(1).g1_sparse_colval = int32([]);
M_.block_structure.block(1).g1_sparse_colptr = int32([]);
M_.block_structure.block(2).g1_sparse_rowval = int32([1 2 3 1 4 1 2 3 3 4 5 6 2 1 3 4 5 2 6 1 ]);
M_.block_structure.block(2).g1_sparse_colval = int32([1 2 3 7 7 8 8 8 9 10 11 12 14 15 15 15 15 16 17 18 ]);
M_.block_structure.block(2).g1_sparse_colptr = int32([1 2 3 4 4 4 4 6 9 10 11 12 13 13 14 18 19 20 21 ]);
...
M_.dynamic_g1_sparse_rowval = int32([1 2 3 5 6 7 1 2 3 2 3 4 4 1 5 2 6 3 7 8 9 1 2 3 4 8 1 9 3 5 6 7 ]);
M_.dynamic_g1_sparse_colval = int32([1 2 3 5 6 7 10 10 10 11 12 12 13 14 14 15 15 16 16 17 18 19 20 20 20 20 22 26 27 28 29 30 ]);
M_.dynamic_g1_sparse_colptr = int32([1 2 3 4 4 5 6 7 7 7 10 11 13 14 16 18 20 21 22 23 27 27 28 28 28 28 29 30 31 32 33 ]);
M_.lhs = {
'L_GDP_GAP'; 
'DLA_CPI'; 
'RS'; 
