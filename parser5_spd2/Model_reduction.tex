...
\section{Identification of equations/variables}
\begin{enumerate}
\item Dynamic: A variable that contains leads and lags of its own variable. 
\item Static: Equations/variables that at time t are defined purely by other
variables at time t, or the expected value of other variables. The
variable itself does not appear with a lead or lag in its own definition.
\end{enumerate}
...
\section{Eliminate Static Equations}
\begin{verbatim}
// Aggregate demand
...
\section{Reduce the system again.}
\begin{verbatim}
