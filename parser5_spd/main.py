...
def main():
    ...
    # )
    # solver.solve_model(method='spd')
    # if not solver.is_solved:
    #     sys.exit("Core solution failed.")

    solver = SimpleModelSolver("model_files/model_json.json",
                            "model_files/jacobian_matrices.py",
                            "model_files/model_structure.py")
#    out_k = solver.solve_model(method="klein")
    out_s = solver.solve_model(method="spd")
